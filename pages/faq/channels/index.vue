<template>
   <section>
      ...
      <div class="faq_stickers">
         <section class="container">
            <div class="faq_stickers__cart">
               <div class="news__cart__list">
                  <h2 class="news__title__h2">Каналы в Telegram</h2>
               </div>
...
import faqChannelsListApi from '@/data/faqChannelsListApi';
export default {
   data(){
      return{
         faqStickers:faqChannelsListApi
      }
   },
