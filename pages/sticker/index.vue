               ...
               <ul class="sticker__cart__item">
                  <li>
                     <button
                        ...
                        @click="stickerPage = true"
                        :class="{ sticker__active: stickerPage == true }"
                     >
                        ВСЕ СТИКЕРЫ
                     </button>
                  </li>
                  ...
                  <li>
                     <button
                        class="sticker__buttom"
                        @click="stickerPage = false"
                        :class="{ sticker__active: stickerPage == false }"
                     >
                        ИЗ ВКОНТАКТЕ
                     </button>
                  </li>
...
export default {
   ...
   computed: {
      ...
      anime() {
         ...
         return stickerAnimeApi.slice(
            offset,
            offset + this.productsPerPageAnime
         );
      },
