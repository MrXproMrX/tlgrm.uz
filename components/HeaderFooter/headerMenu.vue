<template>
   <div class="header__list">
      <div class="header__logo">
         <nuxt-link to="/">
            <img src="@/assets/foto/logo.svg" alt="">
            <span>
               tlgrm.uz
            </span>
         </nuxt-link>
      ...
      <button class="header__menu__burger" @click="headerBurger = !headerBurger">
         <i class="fas fa-bars"></i>
      </button>

      <section :class="{header__burger__fon:headerBurger}" @click="headerBurger = !headerBurger"></section>
   </div>
</template>
